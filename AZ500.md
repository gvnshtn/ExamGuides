...
* MS Learn content is still being updated, although new content has been posted it does seem to have some teething issues in alignment with the Skills Measured page.
...
* Mark O'Shea exam guide has been updated to reflect the new material:
...
<br>
1. Read 'Make It Stick: The Science of Successful Learning' (ISBN:9780674729018).
2. Print this page out and check off the docs as you move through the list.
